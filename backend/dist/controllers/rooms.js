      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            _context2.next = 5;
            return connection.query("SELECT * FROM rooms WHERE id =?", [req.params.id]);
          case 5:
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            _context3.next = 5;
            return connection.query("SELECT COUNT(*) FROM rooms");
          case 5:
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            ...
            _context4.next = 5;
            return connection.query("INSERT INTO rooms(person, numberPeople, entryDate, outputDate) VALUES (?,?,?,?)", [req.body.person, req.body.numberPeople, req.body.entryDate, req.body.outputDate]);
          case 5:
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 2:
            ...
            _context5.next = 5;
            return connection.query("DELETE FROM rooms WHERE id =?", [req.params.id]);
          case 5:
            res.sendStatus(204);
            // res.json({
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 2:
            ...
            _context6.next = 5;
            return connection.query("UPDATE rooms SET ? WHERE id = ?", [req.body, req.params.id]);
          case 5:
            res.sendStatus(204);
          case 6:
          case "end":
